...
class MyGame(arcade.Window):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        if row < ROW_COUNT and column < COLUMN_COUNT:
            ...
            # Turn over squares around selected position
            # Square above
            if row + 1 < ROW_COUNT and self.grid[row + 1][column] == 0:
                self.grid[row + 1][column] = 1
            elif row + 2 < ROW_COUNT and self.grid[row + 1][column] == 1:
            ...
            if row - 1 >= 0 and self.grid[row - 1][column] == 0:
                ...
                self.grid[row - 1][column] = 0
            # Square to the left
            if column - 1 >= 0 and self.grid[row][column - 1] == 0:
                self.grid[row][column - 1] = 1
            elif column - 1 >= 0 and self.grid[row][column - 1] == 1:
